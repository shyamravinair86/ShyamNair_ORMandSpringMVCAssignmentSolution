...
public class CustomerController {
	...
	@RequestMapping("/save")
	public String save(@RequestParam("id") int theId, @RequestParam("firstName") String theFirstName, @RequestParam("lastName") String theLastName, @RequestParam("email") String theEmail, Model theModel) {
